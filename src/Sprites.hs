...
*                              Hamster Balls                                 *
* Purpose:                                                                   *
*    Provides the necessary tools for drawing flat sprites using OpenGL.     *
*    Sprites are simply drawn as quads (sets of four points) w/ textures     *
*    This module provides functions for easily setting up the environment,   *
*    loading textures, and drawing them to the screen.                       *
*    Adapted from sample code somewhere. Apologies for lack of full credit   *
...
-- this function takes two Int's, the screen length and the screen height.
-- Note that these numbers do not need to corrospond to the window size in any way.
