...
bvTransform trans BoundingEmpty = BoundingEmpty
...
collidesWith b1@(BoundingBox (Vec3d (minx1,miny1,minz1)) (Vec3d (maxx1,maxy1,maxz1)))
             b2@(BoundingBox (Vec3d (minx2,miny2,minz2)) (Vec3d (maxx2,maxy2,maxz2))) = {-debug ("CollidesWith called on " ++ (show b1) ++ " ::: " ++ (show b2) ++ " ::: returning " ++
